# Contributing to tc-font-pdfa

Thank you for your interest in contributing to **tc-font-pdfa**.  
...
```bash
git clone https://github.com/tecnickcom/tc-font-pdfa.git
cd tc-font-pdfa
make buildall
```
...
2. **Search [existing issues](https://github.com/tecnickcom/tc-font-pdfa/issues)** to avoid duplicates.

If no existing issue matches, [open a new one](https://github.com/tecnickcom/tc-font-pdfa/issues/new) and include:

- A **clear title and description** of the problem.
- The **library version** (`composer show tecnickcom/tc-font-pdfa`) and PHP version.
...
1. [Fork the repository](https://github.com/tecnickcom/tc-font-pdfa/fork) and create a branch from `main`:
   ```bash
...
1. **Open a Feature Request** on [GitHub Issues](https://github.com/tecnickcom/tc-font-pdfa/issues/new) describing the use case and proposed API.
...
If you have a question that is not covered here, feel free to open a [GitHub Discussion](https://github.com/tecnickcom/tc-font-pdfa/discussions) or contact the maintainer at [info@tecnick.com](mailto:info@tecnick.com).
