...
This document describes the security policy for **tc-font-pdfa**.
...
1. **Email** the maintainer directly at **[info@tecnick.com](mailto:info@tecnick.com)** with the subject line:  
   `[SECURITY] tc-font-pdfa – <brief description>`
...
- **Environment** — PHP version, OS, library version (output of `composer show tecnickcom/tc-font-pdfa`).
...
- **Keep dependencies up to date.** Run `composer update` regularly and monitor advisories via [Packagist Security Advisories](https://packagist.org/packages/tecnickcom/tc-font-pdfa) or tools such as `composer audit`.
...
| GitHub repository | <https://github.com/tecnickcom/tc-font-pdfa> |
| Packagist | <https://packagist.org/packages/tecnickcom/tc-font-pdfa> |
